...
export const GLOSSARY: GlossaryTerm[] = [
  ...
  { term: 'Makruh', termAr: 'المكروه', termFr: 'Déconseillé', definition: 'Action déconseillée sans être strictement interdite. Sa délaissement est préférable.', category: 'fiqh' },
  ...
  { term: 'Niyya', termAr: 'النية', termFr: 'Intention', definition: 'L\'intention sincere du cœur, condition de validité de tout acte cultuel.', category: 'fiqh' },
  ...
  { term: 'Tayammum', termAr: 'التيمم', termFr: 'Ablation sèche', definition: 'Ablution à la terre/poussière en l\'absence d\'eau ou incapacité d\'en utiliser.', category: 'fiqh' },
  ...
  { term: 'Tasbih', termAr: 'التسبيح', termFr: 'Glorification', definition: 'Glorification d\'Allah, souvent accomplit sur un chapelet (Misbaha) de 33 ou 99 perles.', category: 'spirituality' },
  ...
  { term: 'Tasawwuf', termAr: 'التصوف', termFr: 'Soufisme', definition: 'La voie spirituelle de l\'introspection et du rapprochement de Allah par la piété et l\'ascèse.', category: 'concepts' },
  ...
  { term: 'Sahur', termAr: 'السحور', termFr: 'Repas de l\'aube', definition: 'Repau pris avant l\'aube pour débuter le jeûne de la journée de Ramadan, recommandé.', category: 'times' },
